...
**라운지 테마 (Lounge Theme)**
- 메인 화면과 프로필의 텍스트를 포함하여 피드 내 모든 UI 요소에 7가지 테마(Pastel, Cyberpunk, Holographic, Neon, High Contrast, Forest, Claude Code) 자유롭게 적용
- '고대비' 전용 **퓨어 블랙 와이어프레임(Wireframe)** 엔진 지원
